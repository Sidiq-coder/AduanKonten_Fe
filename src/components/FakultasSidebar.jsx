import { Home, Ticket, LogOut, Settings, ChevronDown } from "lucide-react";
import { UnilaLogo } from "./UnilaLogo";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger, } from "./ui/dropdown-menu";
export function FakultasSidebar({ currentPage, onNavigate, fakultasName, userEmail, onLogout }) {
    // Get initials from fakultas name
    ...
    const initials = getInitials(fakultasName);
    return (<div className="w-[260px] min-h-screen sticky top-0 self-start bg-gradient-to-b from-[#003D82] to-[#002E5B] text-white flex flex-col shadow-xl flex-shrink-0">
      ...
      <div className="p-5">
        <div className="bg-white/10 rounded-lg px-3 py-2 mb-4">
          <p className="text-xs text-white/60 mb-1">Fakultas</p>
          <p className="text-sm">{fakultasName}</p>
        </div>
