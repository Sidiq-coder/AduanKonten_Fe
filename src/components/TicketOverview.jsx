...
import { FileText, Clock, CheckCircle2, XCircle, Loader2, Activity } from "lucide-react";
...
const PRIORITY_CONFIG = [
    { key: "urgent", label: "Urgent", accent: "bg-red-100", bar: "bg-red-500" },
    { key: "high", label: "Tinggi", accent: "bg-orange-100", bar: "bg-orange-500" },
    { key: "medium", label: "Sedang", accent: "bg-amber-100", bar: "bg-amber-500" },
    ...
    const statItems = [
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {statItems.map((stat) => (<div key={stat.label} className="bg-card rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300 border border-border">
            ...
            <div className="text-3xl text-foreground mb-1.5">{stat.value}</div>
